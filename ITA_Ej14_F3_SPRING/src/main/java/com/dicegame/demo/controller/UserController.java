...
public class UserController {
	...
	@PreAuthorize("hasRole('ADMIN')")  ///// SOLO LOS ADMINS PUEDEN VER EL RANKING MEDIO 
	...
	//UPDATE un user
	@PreAuthorize("hasRole('ADMIN')")  ///// SOLO LOS ADMINS PUEDEN HACER UPDATE
	...
	@PreAuthorize("hasRole('ADMIN')")  ///// SOLO LOS ADMINS PUEDEN BORRAR USERS
